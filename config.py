...
CUSTOMER_SUPPORT_TEAM_IDS = [713830377189277845, 1050451653070950503, 585751002167115806, 412607075622060032, 1255068242469326928, 1120088026828242976, 517856669338959881, 388031483924840460, 419205987895869440, 11728720708042834]
TEST=os.getenv('TEST')
SUPER_KICKER_IDS = [
    1114614606128758905,
    791593422443380746,
...
BOOST_CHANNEL_ID = 1284545945324752988
