...
class BoostView(View):
    ...
    @discord.ui.button(label="Boost", style=discord.ButtonStyle.success, custom_id="play_user")
    async def play(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        serviceId = self.service["profileId"]
        payment_link = f"https://app.sidekick.fans/support/{serviceId}"
        await interaction.followup.send(f"It is time to boost kicker! Follow link and complete payment: {payment_link}", ephemeral=True)
