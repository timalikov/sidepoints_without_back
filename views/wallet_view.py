...
class Wallet_exist(View):
    ...
    async def balance_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if wallet_address:
            ...
            await interaction.followup.send(f"Please create a crypto-wallet connected to your discord account via link: https://app.sidekick.fans/manage", ephemeral=True)
